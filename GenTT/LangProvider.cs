...
namespace Win10Tools.Langs
{
    public class LangProvider : INotifyPropertyChanged
    {
        internal static LangProvider Instance => ResourceHelper.GetResource<LangProvider>("Win10ToolsLangs");
		...
		private void UpdateLangs()
        {
			...
			OnPropertyChanged(nameof(AppClosingTip1));
			...
			OnPropertyChanged(nameof(LangComment1));
			...
			OnPropertyChanged(nameof(Repository1));
			...
			OnPropertyChanged(nameof(SetIME));
			...
			OnPropertyChanged(nameof(Vsix1));
        ...
        ///   查找类似 托盘图标已打开，将隐藏窗口而不是关闭程序 的本地化字符串。
        /// </summary>
		public string AppClosingTip1 => Lang.AppClosingTip1;
        ...
        ///   查找类似 查找类似 {0} 的本地化字符串。 的本地化字符串。
        /// </summary>
		public string LangComment1 => Lang.LangComment1;
        ...
        ///   查找类似 请输入关键字 的本地化字符串。
        /// </summary>
		public string PlsEnterKey1 => Lang.PlsEnterKey1;
        ...
        ///   查找类似 实用例子 的本地化字符串。
        /// </summary>
		public string PracticalDemos1 => Lang.PracticalDemos1;
        ...
        ///   查找类似 代码仓库 的本地化字符串。
        /// </summary>
		public string Repository1 => Lang.Repository1;
        ...
        ///   查找类似 输入法 的本地化字符串。
        /// </summary>
		public string SetIME => Lang.SetIME;
        ...
        ///   查找类似 提示 的本地化字符串。
        /// </summary>
		public string Tip1 => Lang.Tip1;

        /// <summary>
        ///   查找类似 Win10工具箱 的本地化字符串。
        /// </summary>
        ...
        ///   查找类似 VS 插件 的本地化字符串。
        /// </summary>
		public string Vsix1 => Lang.Vsix1;
    ...
    public class LangKeys
    {
        ...
        ///   查找类似 托盘图标已打开，将隐藏窗口而不是关闭程序 的本地化字符串。
        /// </summary>
		public static string AppClosingTip1 = nameof(AppClosingTip1);
        ...
        ///   查找类似 查找类似 {0} 的本地化字符串。 的本地化字符串。
        /// </summary>
		public static string LangComment1 = nameof(LangComment1);
        ...
        ///   查找类似 请输入关键字 的本地化字符串。
        /// </summary>
		public static string PlsEnterKey1 = nameof(PlsEnterKey1);
        ...
        ///   查找类似 实用例子 的本地化字符串。
        /// </summary>
		public static string PracticalDemos1 = nameof(PracticalDemos1);
        ...
        ///   查找类似 代码仓库 的本地化字符串。
        /// </summary>
		public static string Repository1 = nameof(Repository1);
        ...
        ///   查找类似 输入法 的本地化字符串。
        /// </summary>
		public static string SetIME = nameof(SetIME);
        ...
        ///   查找类似 设置相关 的本地化字符串。
        /// </summary>
		public static string Tab1 = nameof(Tab1);
        ...
        ///   查找类似 提示 的本地化字符串。
        /// </summary>
		public static string Tip1 = nameof(Tip1);
        ...
        ///   查找类似 VS 插件 的本地化字符串。
        /// </summary>
		public static string Vsix1 = nameof(Vsix1);
