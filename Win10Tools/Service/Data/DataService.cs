...
using Win10Tools.Tools.Converter;
using Newtonsoft.Json;

namespace Win10Tools.Service
{
        ...
        internal List<DemoDataModel> GetDemoDataList()
        {
            ...
            for (var i = 1; i <= 20; i++)
            {
                ...
                var model = new DemoDataModel
                {
                    ...
                    Type = (DemoType)i,
                    DataList = dataList,
                    ImgPath = $"/Win10Tools;component/Resources/Img/Avatar/avatar{i % 6 + 1}.png",
        ...
        public List<DemoDataModel> GetDemoDataList(int count)
        {
            ...
            for (var i = 1; i <= count; i++)
            {
                ...
                var model = new DemoDataModel
                {
                    ...
                    Name = $"Name{i}",
                    Type = (DemoType)index,
                    ImgPath = $"/Win10Tools;component/Resources/Img/Avatar/avatar{index}.png",
                    Remark = new string(i.ToString()[0], 10)
                };
                list.Add(model);
            }
